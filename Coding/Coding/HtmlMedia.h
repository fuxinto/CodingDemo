...
+ (void)addMediaItemUser:(HFXUserInfoModel *)curUser toString:(NSMutableString *)curString andMediaItems:(NSMutableArray *)itemList;
...
+ (instancetype)htmlMediaItemWithTypeATUser:(HFXUserInfoModel *)curUser mediaRange:(NSRange)curRange;
